...
import { UserPlus, MapPinned, Calendar, CreditCard, TrendingUp } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-purple-300 text-sm">Aumenta tus ingresos</span>
              </div>
              ...
              <p className="text-slate-300 text-lg mb-8">
                Únete a nuestra red de profesionales verificados y expande tu negocio con WOAMI TECH
              </p>
              ...
              {/* CTA Button */}
              <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg shadow-purple-500/30">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-purple-500/20">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1674471361339-2e1e1dbd3e73?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNoJTIwc3VwcG9ydCUyMHRlY2huaWNpYW4lMjB3b3JraW5nfGVufDF8fHx8MTc2NDI2NDk0M3ww&ixlib=rb-4.1.0&q=80&w=1080"
              ...
              <div className="absolute -bottom-6 -left-6 bg-slate-900/90 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 shadow-xl">
                ...
                <div className="text-slate-300 text-sm">Aumento promedio en ingresos</div>
              </div>
            </div>
          </div>
        </div>
